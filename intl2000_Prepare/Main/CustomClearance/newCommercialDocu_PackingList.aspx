<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newCommercialDocu_PackingList.aspx.cs" Inherits="CustomClearance_newCommercialDocu_PackingList" Debug="true" %>
	...
	<script type="text/javascript">
		...
		function GoClearance(Gubun, Value) {
		    switch (Gubun) {
		        ...
		        case "ShowBL": location.href = "../CustomClearance/newCommercialDocu_HouseBL.aspx?S=" + Value; break;
    ...
    <div>
		...
		<div id="quick_menu">
			<p>
                ...
                <input type="button" class="InputButton" value="Invoice Modify" onclick="GoModify('InvoiceModify', HRequestFormPk.value)" /><br />
                <input type="button" class="InputButton" value="Packing Write" onclick="GoModify('PackingModify', HRequestFormPk.value)"/><br />
			</p>
		</div>
		<script type="text/javascript">
