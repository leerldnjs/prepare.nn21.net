...
public partial class CustomClearance_newCommercialDocu_Invoice : System.Web.UI.Page
{
	...
	SELECT CCWR.MonetaryUnitCL, RFI.MarkNNumber, RFI.Label, RFI.Quantity, RFI.QuantityUnit, RFI.UnitPrice, RFI.Amount, CICK.Description, CICK.Material, Row.C
