            ...
            <tr>
                ...
                <td valign="top" style="width: 1000px; padding-top: 10px;">
                    <table cellpadding="0" cellspacing="0" style="width: 990px; margin-left: 10px;">
                        ...
                        <tr>
                            <td align="center" style="padding-top: 10px;"><%=PageNoHTML %></td>
                        </tr>
                        <tr>
                            <td>
                                <table cellpadding="0" cellspacing="0" style="width: 990px;">
                                    <tr>
                                        ...
                                        <td style="width: 340px;">
                                            <!--select id="SerchType"><option value="1">제목</option><option value="2">내용</option><option value="3">ID</option></!--select-->
                                            <input type="text" style="ime-mode: active;" id="SerchValue" style="width: 200px; height: 16px;" onkeydown="javascript:if(event.keyCode==13){GoSerch(); return false;}" />
                                            &nbsp;<input type="button" value="Search" onclick="GoSerch();" style="width: 60px; height: 22px;" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
