<%@ Page Language="C#" AutoEventWireup="true" CodeFile="T_Write.aspx.cs" Inherits="Board_T_Write" %>
<%@ Register Src="~/Board/BoardList.ascx" TagPrefix="uc1" TagName="BoardList" %>
<%@ Register Src="~/Board/daumeditor/Editor.ascx" TagPrefix="uc2" TagName="Editor" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function setForm(editor) {
            ...
            for (i = 0; i < images.length; i++) {                
                if (images[i].existStage) {
                    ...
                    input = document.createElement('input');
                    input.type = 'hidden';
                    input.name = 'attach_image_SavedPk';
                    input.value = images[i].data.UploadedFilePk;
                    form.createField(input);
                    ////////////////////////////////////////////////
                    ////////////file_size///////////////////////////
                    input = document.createElement('input');
                    input.type = 'hidden';
                    input.name = 'attach_image_filesize';
            ...
            for (i = 0; i < files.length; i++) {
                ...
                input = document.createElement('input');
                input.type = 'hidden';
                input.name = 'attach_file_SavedPk';
                input.value = files[i].data.UploadedFilePk;
                form.createField(input);
                ////////////////////////////////////////////////////////////////////////
                ////////////file_size///////////////////////
                input = document.createElement('input');
                input.type = 'hidden';
                input.name = 'attach_file_filesize';
        ...
        function FileDelete(filePk) {
            $.ajax({
                type: "POST",
                url: "/Main/WebService/Board.asmx/DeleteFile",
                data: "{FilePk:\"" + filePk + "\"}",
                        ...
                        <tr>
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 990px; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td>
                                            <uc2:Editor runat="server" ID="Editor" />
                                        </td>
                                    </tr>
                                    <tr>
