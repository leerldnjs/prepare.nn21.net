...
public partial class Board_SetBoard : System.Web.UI.Page
{
	private DBConn DB;
		...
		switch (Division) {
			case "New":
				...
				DB.SqlCmd.CommandText = "INSERT INTO [BoardContents] ([BoardCode], [Header], [Position], [ParentsPk], [Title], [Contents], [AccountID], [Name]) VALUES (" +
					...
					Common.StringToDB(HTMLHeader, true, true) + ", " +
				...
				break;
			case "Modify":
				DB.SqlCmd.CommandText = "UPDATE [BoardContents] SET [Header] =" + Common.StringToDB(HTMLHeader, true, true) +
