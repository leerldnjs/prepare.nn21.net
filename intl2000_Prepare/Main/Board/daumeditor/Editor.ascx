<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Editor.ascx.cs" Inherits="Board_daumeditor_Editor" %>
<!-- 에디터 컨테이너 시작 -->
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="/Board/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
