<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Editor1.ascx.cs" Inherits="Board_daumeditor_Editor1" %>
<!-- 에디터 컨테이너 시작 -->
<div id="tx_trex_container" class="tx-editor-container">
                    ...
                    <div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
                        ...
                        <div class="tx-menu-footer">
                            <img class="tx-menu-confirm"
                                src="/Board/daumeditor/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt="" />
                            <img class="tx-menu-cancel" hspace="3"
                                src="/Board/daumeditor/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt="" />
                        </div>
                    </div>
                </li>
                <li class="tx-list">
    ...
    <div id="tx_canvas" class="tx-canvas">
        <div id="tx_loading" class="tx-loading">
            <div>
                <img src="/Board/daumeditor/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle" /></div>
        </div>
        ...
        <div id="tx_attach_box" class="tx-attach-box">
            <div class="tx-attach-box-inner">
                <div id="tx_attach_preview" class="tx-attach-preview">
                    <p></p>
                    <img src="/Board/daumeditor/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on" /></div>
