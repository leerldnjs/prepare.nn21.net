<%@ Page Title="" Language="C#" MasterPageFile="~/ViewShare/Clean.Master" AutoEventWireup="true" CodeFile="RequestCharge.aspx.cs" Inherits="Charge_Dialog_RequestCharge" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contents" Runat="Server">
	...
	<div class="panel panel-default">
		<header class="panel-heading font-bold">운임비용</header>
	...
	<input type="hidden" id="TablePk" value="<%=RequestFormPk %>" />
	...
	<input type="hidden" id="ShipperPk" value="<%=ShipperPk %>" />
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			if ($("#AlreadyCalc").val() == "Y") {
				$("#st_StandardPrice").val("<%=Calculated.StandardPricePk %>");
				$("#CriterionValue").val("<%=Calculated.CriterionValue %>");
				$("#OverWeightValue").val("<%=Calculated.OverWeightValue %>");
		...
		function TotalCalc() {
			...
			var ExchangedSetDate = $("#DepartureDate").val();
			var IsEstimation = "";
		...
		function Submit_Charge() {
			...
			var TableName = "RequestForm";
			var TablePk = $("#TablePk").val();
			var ChargeNo = "0";
			var StandardPricePk = $("#st_StandardPrice").val();
			var CriterionValue = $("#CriterionValue").val();
			var OverWeightValue = $("#OverWeightValue").val();
