<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StorageOutForCustoms.aspx.cs" Debug="true" Inherits="Admin_StorageOutForCustoms" %>
...
<head runat="server">
	...
	<script type="text/javascript">
		...
		function DocumentStepCLDateList(toDayList) {
		    if (toDayList == "1") {
		        location.href = 'StorageOutForCustoms.aspx';
		    }
		    else {		       
		        location.href = "StorageOutForCustoms.aspx?TD=" + toDayList;
		    }		   
		}
...
<body style="background-color:#E4E4E4; width:1100px; margin:0 auto; padding-top:10px;" >
	...
	<uc2:Loged ID="Loged1" runat="server" />
		<uc1:LogedWithoutRecentRequest11 ID="LogedWithoutRecentRequest11" runat="server" Visible="false" />
