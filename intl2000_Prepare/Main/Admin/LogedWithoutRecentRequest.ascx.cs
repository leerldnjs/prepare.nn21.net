...
public partial class Admin_LogedWithoutRecentRequest : System.Web.UI.UserControl
{
	...
	protected void Page_Load(object sender, EventArgs e) {
		...
		if (Session["Type"] + "" == "ShippingBranch") {
			ButtonRight += "<input type=\"button\" value=\"" + GetGlobalResourceObject("qjsdur", "ghksdbfwjdqh") + "\" onclick=\"location.href = '../Admin/ExchangeRate.aspx?G=V';\" style=\" height:25px; font-size:12px; \" /> " +
								...
								"<input type=\"button\" value=\"" + GetGlobalResourceObject("qjsdur", "djqcpemdfhr") + "\" style=\" height:25px;font-size:12px;\" onclick=\"GotoForShippingBranch('NewCompany', '" + Session["CompanyPk"] + "');\" />";
		} else {
			//통관,미수등 오른쪽 버튼들///////////////////
