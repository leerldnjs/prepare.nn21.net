<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SettlementWithCustoms_Container.aspx.cs" Inherits="Admin_SettlementWithCustoms_Container" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<script>
		function View(ListPk) {
			location.href = "../Admin/SettlementWithCustoms_Container.aspx?Date=" + ListPk + "&Range=" + document.getElementById("Range").value;
		}
		...
		function SendToBenefit(BLNo, Price) {
			var Date, Description, AccountId;
			Date = '';
			Description = '*ILBenefit*';
			AccountId = form1.AccountID.value;
