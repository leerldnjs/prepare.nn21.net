<%@ Control Language="C#" AutoEventWireup="true" CodeFile="LogedWithoutRecentRequest.ascx.cs" Inherits="Admin_LogedWithoutRecentRequest" %>
   ...
   <table border="0" cellpadding="0" cellspacing="0" style="width: 880px;">
      ...
      <tr>
         ...
         <td style="width: 340px;">&nbsp;&nbsp;
            ...
            <input type="button" value="<%=GetGlobalResourceObject("qjsdur", "cnfrhgusghkd") %>" onclick="location.href = '../Admin/TransportBetweenCompanyList.aspx';" style="width: 70px; height: 30px; font-size: 12px;" />
         </td>
         <td style="padding-right: 10px; text-align: right;">
            <%=ButtonRight %>
         </td>
