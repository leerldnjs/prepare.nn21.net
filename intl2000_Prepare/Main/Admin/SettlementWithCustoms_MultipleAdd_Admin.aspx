<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SettlementWithCustoms_MultipleAdd_Admin.aspx.cs" Inherits="Admin_SettlementWithCustoms_MultipleAdd_Admin" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<script type="text/javascript">
		...
		function SetSave() {
			...
			if (SumBLNo != "") {
				SettlementWithCustoms.SetSettlement_Admin(SumBLNo, SumDate, SumPrice, SumDescription, SumAccountId, function (result) {
					if (result == "1") {
						alert("Success");
						$("#HClipBoard").val("");
