<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="PackingListView.aspx.cs" Inherits="Request_PackingListView" %>
...
<head runat="server">
	...
	<script type="text/javascript">
		...
		function Modify() {
			location.href = "./PackingListWrite.aspx?S=" + form1.HRequestFormPk.value + "&M=IM";
		}
			...
			<div style="width:346px; float:left;">
				...
				<div style="width:173px; height:123px; float:left; ">
					<div class="PortOfLoading" id="PortOfLanding" >
						...
						<div id="DivPortOfLanding" style="padding:10px;"><%=PortOfLanding %></div>
					</div>
					<div class="PortOfLoading" id="Carrier" >
						<strong>Carrier</strong>
						<div id="DivCarrier" style="padding:10px;"><%=Carrier %></div>	
					</div>
				</div>
				<div style="width:173px; height:123px; float:right; ">
					<div class="FinalDestination" id="FinalDestination" >
						...
						<div id="DivFinialDestination" style="padding:10px;"><%=FinalDestination %></div>	
					</div>
					<div class="FinalDestination" id="SailingOnOrAbout" >
						<strong>Sailing on or About</strong>
						<div id="DivSailingOnOrAbout" style="padding:10px;"><%=SailingOnOrAbout %></div>	
					</div>
				</div>
			</div>
			<div style="width:347px; float:right;">
				<div class="InvoiceNo" id="InvoiceNo"   style="height:57px; margin-left:-2px; margin-top:-1px; ">
					...
					<div style="padding-left:25px; padding-top:15px;">
						<textarea id="TBInvoiceNo" cols="37" rows="1" style="border:0px; overflow:hidden; width:300px;  " readonly="readonly" ><%=InvoiceNo %></textarea>
					</div>
				</div>
				<div class="InvoiceNo" id="PaymentTerms"   style="height:57px; margin-left:-2px; margin-top:-1px; ">
					<strong>Payment terms</strong>
					<div style="padding-left:25px; padding-top:15px;  ">
						<input type="text" id="TBPaymentTerms" style="border:0px;" readonly="readonly" value="<%=PaymentTerms %>" />
					</div>
				</div>
				<div class="InvoiceNo" id="Buyer"   style="height:55px; margin-left:-2px;  margin-top:-1px; ">
					<strong>Buyer</strong>
					<div style="padding:25px; "><input type="text" id="TBBuyer" style="border:0px;" readonly="readonly" value="<%=Buyer %>" /></div>
				</div>

				<div class="InvoiceNo" id="OtherReferences"   style="margin-left:-2px;  height:214px; margin-top:-1px; ">
					<strong>Other References</strong>
					<div style="padding-left:25px; padding-top:15px;">
						<textarea id="TBOtherReferences" cols="37" rows="8" style="border:0px; overflow:hidden; line-height:20px; height:160px; width:300px;" readonly="readonly"><%=Memo %></textarea>
					</div>
				</div>
			</div>
				...
				<table border="0" cellpadding="0" cellspacing="0" style="width:694px;">
					...
					<tbody>
						...
						<tr style="height:40px;">
							...
							<td class="BB" style="text-align:right; padding-right:10px; font-weight:bold;" ><%=TotalGrossWeight %></td>
							<td class="BR BB" colspan="2" style="text-align:right; padding-right:10px; font-weight:bold;" ><%=TotalVolume %></td>
						</tr>
					</tbody>
				</table>
			</div>
