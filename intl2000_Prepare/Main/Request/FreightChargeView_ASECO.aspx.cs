...
public partial class Request_FreightChargeView_ASECO : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e) {
		...
		if (gubun == "FreightInvoice") {
			...
			Freight = FreightLoad2015(Request.Params["S"], SorC);
		}
		DB.DBCon.Close();
	}
  ...
  WHERE RequestFormPk=" + RequestFormPk + ")";
	...
	"	<tr><td>B / L TERMS</td><td>FREIGHT COLLECT</td><td>" + GetGlobalResourceObject("qjsdur", "wjqtndlftl") + "</td><td>" + RS["DepartureDate"] + "</td></tr>" +
	"	<tr><td>QTY</td><td>" + RS["TotalPackedCount"] + " " + Common.GetPackingUnit(RS["PackingUnit"] + "") + "</td><td>출고예정</td><td>" + RS["ArrivalDate"] + "</td></tr>" +
	...
	"	</table></div>");
					...
					if (ConsigneeCompanyName == "") {
						ConsigneeCompanyName = "<strong> " + RS["ConsigneeCompanyName"] + "(" + RS["ConsigneeCode"] + ") </ strong > &nbsp; &nbsp; &nbsp; &nbsp; TEL: " + RS["ConsigneeCompanyTEL"] + " &nbsp; &nbsp; FAX: " + RS["ConsigneeCompanyFAX"];
					} else {
						ConsigneeCompanyName = "<strong>" +ConsigneeCompanyName+ "</strong>";
					}
					


					Html.Append("<div class=\"Title\">" +
	"<div style=\"border:1px black solid; padding:10px;\">"+ConsigneeCompanyName+ "</div><br />" +
	"<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" style=\"width:695px; height:70px; \">" +
	"	<tr><td colspan=\"2\">Shipper. " + RS["ShipperCompanyName"] + " (" + RS["ShipperCode"] + ")</td><td>TEL : " + "</td><td>FAX : " + RS["ShipperCompanyFAX"] + "</td></tr>" +
	"	<tr><td>B / L NO</td><td>" + RS["BLNo"] + "</td><td>" + GetGlobalResourceObject("qjsdur", "dnsthddlfwjd") + "</td><td>" + /*RS["DepartureName"] + " - " + RS["ArrivalName"] + " " + Common.GetTransportWay(RS["TransportWayCL"] + "") +*/ (RS["DepartureDate"] + "" == "" ? "" : string.Format("{0}.{1}.{2}", ("" + RS["DepartureDate"]).Substring(0, 4), ("" + RS["DepartureDate"]).Substring(4, 2), ("" + RS["DepartureDate"]).Substring(6, 2))) + " - " +
...
SELECT R.ArrivalDate, R.ShipperPk, R.ConsigneePk, R.ShipperCode, R.ConsigneeCode
	...
	, RFCH.TotalPackedCount, RFCH.PackingUnit, RFCH.TotalGrossWeight, RFCH.TotalVolume, RFCH.[ConsigneeCharge] 
...
"<td colspan='6' style=\"text-align:right; font-size:20px; padding-top:20px; padding-right:20px; padding-right:10px; font-weight:bold; border-bottom:double 5px black;\">" +
	...
	private String ItemLoad(string RequestFormPk) {
		...
		RS.Dispose();
		DB.SqlCmd.CommandText = @"SELECT	RFCH.TotalPackedCount, RFCH.PackingUnit, RFCH.TotalGrossWeight, RFCH.TotalVolume 
	...
	private String TitleLoad(string RequestFormPk) {
		...
		if (RS.Read()) {
			...
			ReturnValue = "<div style=\"border-bottom:solid 2px black; width:692px; height:75px; text-align:center; padding-top:3px; \">" +
				"<div style=\"font-size:18px; font-weight:bold; text-align:center; letter-spacing:3px;\">" + "ASECO SHIPPING" + "</div>" +
				"<div style=\"font-size:12px; text-align:center; padding-top:15px; letter-spacing:1px;   \">" + "KYUNGKI-DO PYUNGTAEK-SI POSEUNG-EUP PYUNGTAEKHANGMAN-GIL 86" + "</div>" +
				"<div style=\"font-size:12px; text-align:center; padding-top:5px; letter-spacing:1px;   \">TEL : " + "031-682-1566" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;FAX : " + "031-682-1565" + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E-mail : " + "asecologis@gmail.com" + "</div>" +
			"</div>";
		}
		RS.Dispose();
		return ReturnValue;
...
SELECT 
	...
	, RCH.TotalPackedCount, RCH.PackingUnit, RCH.TotalGrossWeight, RCH.TotalVolume, RCH.ShipperMonetaryUnit, RCH.ShipperCharge, RCH.ConsigneeMonetaryUnit, RCH.ConsigneeCharge, RCH.ShipperDepositedDate, RCH.ShipperDeposited, RCH.ConsigneeDepositedDate, RCH.ConsigneeDeposited, RCH.WillPayTariff , RCH.ExchangeRate
	, Tariff.TSum
...
comment.Replace("\r", "<br/>") +
			...
			if (OurBranchPk == "3157") {
				bankaccount = @"신한은행 (주)아세코쉬핑 140-011-709594 ";
   ...
   "<div>" + staff + "&nbsp;&nbsp;&nbsp;<strong>" + bankaccount + "</strong></div>" +
								comment.Replace("\r", "<br/>") +
							"</div>";
			} else {
				BankInfo = "<div style=\"font-size:17px; margin-top:10px; padding-top:10px; line-height:20px; text-align:left;\">" +
...
where isdel = 0 and GubunPk={0}", OurBranchPk);
		...
		Html_BankInfo = "";
		while (RS.Read()) {
			Html_BankInfo += "신한은행" + " " + "(주)아세코쉬핑" + " " + "140-011-709594" + "<br />";
		}
		RS.Dispose();
